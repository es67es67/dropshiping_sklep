...
async function syncImportMiejscowosci() {
    try {
        console.log('🚀 ROZPOCZYNAM SYNCHRONICZNY IMPORT MIEJSCOWOŚCI...');
        ...
        // Przetwarzaj plik CSV synchronicznie
                ...
                .on('data', (row) => {
                    ...
                    try {
                        ...
                        if (woj !== 'brak' && pow !== 'brak' && gmi !== 'brak' && sym !== 'brak') {
                            ...
                            // Zapisz pojedynczy dokument synchronicznie
                            Miejscowosc.create(miejscowoscData)
                                .then(() => {
                                    importedCount++;
